...
//Rare exceptions to indicate a bug in the _voshell_michael_week1_project code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Voshell_Michael_week1_project proxies.
 */
