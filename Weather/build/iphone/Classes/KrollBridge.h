...
@interface Voshell_Michael_week1_projectObject : KrollCoverageObject {
#else
@interface Voshell_Michael_week1_projectObject : KrollObject {
#endif
@private
...
extern NSString * Voshell_Michael_week1_project$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Voshell_Michael_week1_projectObject *_voshell_michael_week1_project;
    KrollObject* console;
	BOOL shutdown;
