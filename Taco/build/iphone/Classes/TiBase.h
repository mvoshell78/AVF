...
// in simulator we redefine to format for Taco Developer console
...
{\
	NSString * exceptionName = [@"org.taco." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.taco";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITacoNativeItemNone = -1, 
	UITacoNativeItemSpinner = -2,
	UITacoNativeItemProgressBar = -3,
	
	UITacoNativeItemSlider = -4,
	UITacoNativeItemSwitch = -5,
	UITacoNativeItemMultiButton = -6,
	UITacoNativeItemSegmented = -7,
	
	UITacoNativeItemTextView = -8,
	UITacoNativeItemTextField = -9,
	UITacoNativeItemSearchBar = -10,
	
	UITacoNativeItemPicker = -11,
	UITacoNativeItemDatePicker = -12,
	
	UITacoNativeItemInfoLight = -13,
	UITacoNativeItemInfoDark = -14,
	
	UITacoNativeItemDisclosure = -15,
	
	UITacoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Taco instances of
