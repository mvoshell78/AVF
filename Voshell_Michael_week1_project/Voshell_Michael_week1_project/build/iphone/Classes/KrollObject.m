...
//@interface Voshell_Michael_week1_projectObject : NSObject
//@end

@interface Voshell_Michael_week1_projectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Voshell_Michael_week1_projectObject class]])
		{
			for (NSString *key in [[(Voshell_Michael_week1_projectObject*)o modules] allKeys])
			{
