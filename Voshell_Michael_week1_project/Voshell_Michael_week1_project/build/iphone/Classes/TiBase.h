...
// in simulator we redefine to format for Voshell_Michael_week1_project Developer console
...
{\
	NSString * exceptionName = [@"org.voshell_michael_week1_project." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.voshell_michael_week1_project";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIVoshell_Michael_week1_projectNativeItemNone = -1, 
	UIVoshell_Michael_week1_projectNativeItemSpinner = -2,
	UIVoshell_Michael_week1_projectNativeItemProgressBar = -3,
	
	UIVoshell_Michael_week1_projectNativeItemSlider = -4,
	UIVoshell_Michael_week1_projectNativeItemSwitch = -5,
	UIVoshell_Michael_week1_projectNativeItemMultiButton = -6,
	UIVoshell_Michael_week1_projectNativeItemSegmented = -7,
	
	UIVoshell_Michael_week1_projectNativeItemTextView = -8,
	UIVoshell_Michael_week1_projectNativeItemTextField = -9,
	UIVoshell_Michael_week1_projectNativeItemSearchBar = -10,
	
	UIVoshell_Michael_week1_projectNativeItemPicker = -11,
	UIVoshell_Michael_week1_projectNativeItemDatePicker = -12,
	
	UIVoshell_Michael_week1_projectNativeItemInfoLight = -13,
	UIVoshell_Michael_week1_projectNativeItemInfoDark = -14,
	
	UIVoshell_Michael_week1_projectNativeItemDisclosure = -15,
	
	UIVoshell_Michael_week1_projectNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Voshell_Michael_week1_project instances of
