...
/**
 Base class for all Voshell_Michael_week1_project views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Voshell_Michael_week1_project view hierarchy (such as wrapped iOS UIViews) was touched.
