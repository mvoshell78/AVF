...
/**
 The base class for all Voshell_Michael_week1_project modules
 */
...
/**
 Voshell_Michael_week1_project Platform calls this method on startup.
 */
-(void)startup;

/**
 Voshell_Michael_week1_project Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Voshell_Michael_week1_project Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Voshell_Michael_week1_project Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Voshell_Michael_week1_project Platform calls this method on resume.
 @param sender The sender of the event.
 */
